...
public final class MapWithoutNullKey<K, V> extends AbstractMap<K, V> {
    ...
    public V put(K key, V value) {
        Objects.requireNonNull(key, "null key not allowed");
    ...
    public boolean equals(Object obj) {
        ...
        MapWithoutNullKey that = (MapWithoutNullKey) obj;
